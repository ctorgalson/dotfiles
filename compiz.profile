...
[core]
s0_active_plugins = core;composite;opengl;grid;resize;place;imgpng;snap;wall;mousepoll;unitymtgrabhandles;commands;move;regex;vpswitch;compiztoolbox;copytex;session;animation;expo;fade;workarounds;ezoom;scale;unityshell;
...
s0_put_topleft_key = <Control><Super>4
s0_put_topright_key = <Control><Super>1
s0_put_bottomleft_key = <Control><Super>3
s0_put_bottomright_key = <Control><Super>2
